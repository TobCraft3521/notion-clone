...
export const upsertProductRecord = async (product: Stripe.Product) => {
  ...
  console.log("💳 Product inserted or updated: ", product.id)
}
...
export const manageSupscriptionStatusChange = async (
  ...
  try {
    ...
    if (creatAction && subscription.default_payment_method && uuid) {
